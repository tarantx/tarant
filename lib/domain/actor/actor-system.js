...
class ActorSystem {
    constructor({ schedulerInterval, supervisor, materializer, eventBus } = {}) {
        ...
        let system = this;
        this.__actorClass = class extends Actor {
            static create(id, initialState) {
                let instance = super.create(id, initialState, { materializer: system.materializer, system: system });
                system.actors[instance.id] = instance;
                return instance
            }
        }
    }
